...
def run_speculative(
    ...
    while len(out) < max_tokens:
        ...
        temp_draft_cache = clone_cache_objects(draft_cache)
        ...
        for _ in range(proposal_limit):
            ...
            cur_draft_logits = forward_one(draft_lm, dtok[:, None], temp_draft_cache)
        ...
        temp_target_cache = clone_cache_objects(target_cache)
        verify_logits = forward_many(target_lm, proposal, temp_target_cache)
