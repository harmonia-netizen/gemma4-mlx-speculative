...
def template_draft_text(user_prompt):
    ...
    # Medium/long template candidates are disabled in v10.
    # Verifying them on the live target cache can poison subsequent greedy
    # fallback even after restore_full(). Keep v10 correctness-first and move
    # isolated-cache template verification to v11.
...
def run_speculative(
    ...
    while len(out) < max_tokens:
        ...
        for proposed_id in proposal_ids:
