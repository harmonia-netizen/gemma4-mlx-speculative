...
def main():
    commands = [
        # 1. Unit tests requiring actual models
        ".venv/bin/python experiments/test_agent_mock_runtime.py",
        
        # 2. Benchmarks requiring actual models
        ...
        # 3. Probes requiring actual models
    ...
    # 4. GGUF Template Draft Validation
